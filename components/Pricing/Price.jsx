...
export function Price() {
  ...
  // Map package index to corresponding translation objects for Simple and With VPN
  const packageTranslations = [
    { simple: t.one_Month, vpn: t.one_Month_VPN },
    { simple: t.three_Month, vpn: t.three_Month_VPN },
    { simple: t.six_Month, vpn: t.six_Month_VPN },
    { simple: t.one_Year, vpn: t.one_Year_VPN }
  ];
  ...
  return (
    <div className="w-full px-4 py-8 bg-[#1b1a1a] flex flex-col items-center justify-center gap-8">
        ...
        <div className="flex flex-wrap justify-center items-center gap-4 md:gap-6 mt-12">
          {["1 Month Package", "3 Month Package", "6 Month Package", "1 Year Package"].map((item, index) => (
            <div key={index} className={`px-6 py-3 rounded-full text-white text-lg font-medium flex items-center justify-center 
              ${index === selectedPackage ? "bg-[#30A179] hover:text-white" : "bg-[#2d2d2d] hover:bg-[#30A179] hover:text-white"} 
      ...
      {/* Pricing Cards Section - Scandinavian */}
        ...
        {isConnection && (
          <>
            <motion.div
              ...
              transition={{ delay: 0.5, duration: 1 }}
            >
              <PriceCard t={packageTranslations[selectedPackage].simple} Price={selectedPackage + 1} />
            </motion.div>
            <motion.div
              initial={{ scale: 1.5, opacity: 0 }}
              animate={{ scale: 1.0, opacity: 1 }}
            ...
            >
              <PriceCard t={packageTranslations[selectedPackage].vpn} Price={selectedPackage + 1} isVPN />
            </motion.div>
          </>
        )}
      </div>

      {/* Content Between Cards - Scandinavian */}
      {isVisible && <motion.div
        className="w-full max-w-6xl text-center my-16 flex flex-col items-center justify-center"
        initial={{ scale: .5, opacity: 0 }}
        animate={{ scale: 1.0, opacity: 1 }}
      ...
      >
        <div className="mb-12 flex flex-col items-center justify-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-8 text-center">
            <span className="text-[#30A179]">{t.title1} </span> {t.country}
          </h2>
      ...
      {/* Second Row - Arabic IPTV Package */}
      ...
      >
        <div className="mb-12 flex flex-col items-center justify-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-8 text-center">
            <span className="text-[#30A179]">{t.arbic_title}</span> {t.middle}
          </h2>
          <p className="text-lg md:text-xl text-white/80 font-normal max-w-4xl mx-auto mb-12 text-center">
            {t.p2}
          </p>
...
const PriceCard = ({ t, Price, isVPN = false }) => {
  return (
    <div
      ...
      <div className="w-[450px] 2xl:w-[450px] max-sm:w-[350px] xl:w-[400px] relative overflow-hidden">
        <div className="transform sm:scale-100 scale-90 origin-top">
          <div className="relative w-full h-[1090px] rounded-[32.32px]">
            <div className={`absolute left-0 top-0 w-full h-[1079.97px] ${isVPN ? 'bg-[#2d2d2d]' : 'bg-[#2d2d2d]'} rounded-[26px]`} />
